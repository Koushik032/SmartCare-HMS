...
urlpatterns = [
    ...
    path('receptionist/doctors/toggle-availability/<int:doctor_id>/',views.receptionist_toggle_doctor_availability,name='receptionist_toggle_doctor_availability'),
